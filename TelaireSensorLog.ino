//Created by Vannystick to support Element 14 review of AmphenolAirQuality Dev Kit
//https://www.element14.com/community/roadTestReviews/2461/l/amphenol-air-quality-engineering-dev-kit-review
//Based on code from;
//https://github.com/AmphenolAdvancedSensors/Telaire
...
#define RTC_SD //enable or disable logging to SD card with RTC time stamp
...
#define LOG_INTERVAL 1000 //time between log interval
#define SYNC_INTERVAL 1000 //Mills to wait to write to SD
...
// set date time callback function Makes sure to write current date time in new SD file
 SdFile::dateTimeCallback(dateTime); 
  ...
  logfile.println("millis,stamp,datetime,CO2ppm,Temp,Humidity,Dustppm(2.5),AQI(US_EPA)");   
  
  #ifdef USB
    Serial.println("millis,stamp,datetime,CO2ppm,Temp,Humidity,Dustppm(2.5),AQI(USEPA)");
  #endif //ECHO_TO_SERIAL
...
#ifdef RTC_SD //output to Log File
...
// fetch the time
  ...
  logfile.print(", ");
    ...
    if ((Connected & B00001000) == 8 ) {    //is dust sensor present?
      logfile.print(PM2_Value); logfile.print (", ");
      logfile.print (AQIColour);
    }
    logfile.println ("");
...
//____________________________Sub Routines___________________________
